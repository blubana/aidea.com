...
if __name__ == "__main__":
    ...
    parser.add_argument("--sequence-feature-set", choices=("base", "score", "enhanced", "semantic"), default="semantic")
    parser.add_argument("--tabular-feature-set", choices=("base", "score", "enhanced", "semantic"), default="semantic")
